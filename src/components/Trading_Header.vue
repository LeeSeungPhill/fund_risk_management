...
export default {
    data: () => {
        return {
            ...
            selected: 'phills75',
            options: [
                { text: 'Jupyter', value: 'phills75' }, { text: 'Terra', value: 'phills2' }, { text: 'Honey', value: 'chichipa' }, { text: 'Tess', value: 'honeylong' }, { text: 'Mama', value: 'yh480825' }, { text: 'Star', value: 'mamalong' }, { text: 'Leo', value: 'phills13' }, { text: 'Sharon', value: 'phills15' }
            ],
