      ...
      <v-container fluid>
          <v-row no-gutter>
              ...
              <v-col align="right">
                ...
                <v-btn @click="runStockSearch('3')" style="background: rgb(255, 0, 135)">[파워급등주]</v-btn>
                <v-btn @click="runStockSearch('4')" style="background: rgb(195, 0, 135)">[파워종목]</v-btn>
              </v-col>
          </v-row>    
          <v-row no-gutter>      
              <v-col align="left">
      ...
      data() {
        return {
            ...
            options1: [
              ...
              { text: '파워급등주', value: '파워급등주' },
              { text: '파워종목', value: '파워종목' }
            ],
            data: {
              search_day: null,
              search_name: null,
